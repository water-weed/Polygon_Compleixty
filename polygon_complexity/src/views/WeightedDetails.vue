<template>
    <!--<div>
      ...
      <table border="1">
        <thead>
          <tr>
            <th>Frequency of the vibration</th>
            <th>Amplitude of the vibration</th>
            <th>Deviation from the convex hull</th>
            <th>Complexity</th>
          </tr>
        </thead>
        <tbody>
    ...
    <el-container>
      ...
      <el-container class="main-content">
        ...
        <el-table :data="[details]" border>
          ...
          <el-table-column prop="freq" label="Frequency of the vibration"></el-table-column>
