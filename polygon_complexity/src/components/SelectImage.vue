...
<template>
    <div class="image-gallery">
      ...
      <button @click="confirmSelection" :disabled="!selectedImage">
        Yes
      </button>
  </template>
  ...
  export default {
    ...
    methods: {
      ...
      async confirmSelection() {
        ...
        try {
          const res = await fetch(this.selectedImage.url);
          const blob = await res.blob(); 

          const file = new File([blob], this.selectedImage.name, {type: blob.type,});
